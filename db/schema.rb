...
ActiveRecord::Schema.define(version: 2021_01_28_204141) do
  ...
  create_table "due_dates", force: :cascade do |t|
    ...
    t.index ["project_id"], name: "index_due_dates_on_project_id"
  end
  ...
  create_table "periodicty_to_project_types", force: :cascade do |t|
    t.bigint "project_type_id", null: false
    t.bigint "periodicity_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "country_id", null: false
    t.index ["country_id"], name: "index_periodicty_to_project_types_on_country_id"
    t.index ["periodicity_id"], name: "index_periodicty_to_project_types_on_periodicity_id"
    t.index ["project_type_id"], name: "index_periodicty_to_project_types_on_project_type_id"
  end
  ...
  add_foreign_key "periodicty_to_project_types", "countries"
  add_foreign_key "periodicty_to_project_types", "periodicities"
  add_foreign_key "periodicty_to_project_types", "project_types"
